...
현재 논문 버전은 **v10**이다. v10은 v09에 9.5절 "보험 업무에서의 적용 가능 영역"을 가설 수준의 사후 논의로 추가한 개정판이며, 수치 결과와 결론은 v08·v09와 같다.

## 현재 버전

- [논문형 연구리포트 v10](<./TimesFM 3 다변량 예측 실증 연구리포트 v10.md>)
- [논문형 연구리포트 v10 PDF](<./TimesFM 3 다변량 예측 실증 연구리포트 v10.pdf>)
